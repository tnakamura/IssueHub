...
namespace IssueHub.Pages
{
    ...
    public partial class AssignedIssuesPage : ContentPage
    {
        public AssignedIssuesPage(IStore<AppState> store)
        {
            InitializeComponent();

            ViewModel = new AssignedIssuesPageViewModel(store);
        ...
        AssignedIssuesPageViewModel ViewModel
        {
            get => BindingContext as AssignedIssuesPageViewModel;
        ...
        async void HandleItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            ViewModel.Store.Dispatch(new SelectAssignedIssue(issue));
